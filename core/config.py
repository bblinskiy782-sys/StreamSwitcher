...
class StreamingConfig:
    # "icecast" = push to external Icecast/Shoutcast server,
    # "builtin" = listeners connect directly to us (RadioBoss-style).
    mode: str = "icecast"
    ...
    builtin_port: int = 8000
    builtin_bind_host: str = "0.0.0.0"
    builtin_public: bool = False
...
class AppConfig:
    ...
    # Multi-channel support: each entry is a dict with ChannelConfig fields.
    # Empty list = legacy single-channel mode (backward compat).
