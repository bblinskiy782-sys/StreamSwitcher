...
/* Allow all widgets to shrink for splitter resizing */
QGroupBox { min-height: 0px; }
QTabWidget { min-height: 0px; }
QListWidget { min-height: 0px; }
QTableWidget { min-height: 0px; }
"""
